package com.example.bffdiabetes.reminder;
...
import com.example.bffdiabetes.Main2Activity;
import com.example.bffdiabetes.R;

import com.example.bffdiabetes.data.AlarmReminderContract;
...
public class ReminderAlarmService extends IntentService {
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        Intent activityIntent = new Intent(getApplicationContext(), Main2Activity.class);
